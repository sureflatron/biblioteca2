...
require_once("include/public_tema_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_tema_edit";
...
$page_layouts["public_tema_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_tema_list";
...
$page_layouts["public_tema_list"] = $layout;
