...
$layout = new TLayout("export_bootstrap", "ExtravaganzaOrange", "MobileOrange");
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_ejemplares_export";
...
$page_layouts["public_ejemplares_export"] = $layout;
