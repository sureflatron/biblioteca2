...
$layout = new TLayout("edit_bootstrap", "ExtravaganzaOrange", "MobileOrange");
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_ejemplares_edit";
...
$page_layouts["public_ejemplares_edit"] = $layout;
...
$keys = array();
$keys["idejemplares"] = postvalue("editid1");
