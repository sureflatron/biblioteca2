...
$layout = new TLayout("search_bootstrap", "ExtravaganzaOrange", "MobileOrange");
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_ejemplares_search";
...
$page_layouts["public_ejemplares_search"] = $layout;
...
$params['shortTableName'] = 'public_ejemplares';
