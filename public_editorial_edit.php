...
require_once("include/public_editorial_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_editorial_edit";
...
$page_layouts["public_editorial_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_editorial_list";
...
$page_layouts["public_editorial_list"] = $layout;
...
$keys = array();
$keys["ideditorial"] = postvalue("editid1");
