...
require_once("include/public_idioma_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_idioma_edit";
...
$page_layouts["public_idioma_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_idioma_list";
...
$page_layouts["public_idioma_list"] = $layout;
...
$keys = array();
$keys["ididioma"] = postvalue("editid1");
