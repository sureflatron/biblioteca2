...
require_once("include/public_usuario_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_usuario_edit";
...
$page_layouts["public_usuario_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_usuario_list";
...
$page_layouts["public_usuario_list"] = $layout;
