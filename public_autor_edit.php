...
require_once("include/public_autor_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_autor_edit";
...
$page_layouts["public_autor_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_autor_list";
...
$page_layouts["public_autor_list"] = $layout;
...
$keys = array();
$keys["idautor"] = postvalue("editid1");
