...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_lector_masterprint";
...
$page_layouts["public_lector_masterprint"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_ejemplares_masterprint";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterprintheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["public_ejemplares_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "public.prestamo" );
