...
$layout = new TLayout("list_bootstrap1", "ExtravaganzaOrange", "MobileOrange");
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_libro_list";
...
$page_layouts["public_libro_list"] = $layout;
...
$layout = new TLayout("masterlist_bootstrap", "ExtravaganzaOrange", "MobileOrange");
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_editorial_masterlist";
...
$page_layouts["public_editorial_masterlist"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_idioma_masterlist";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterlistheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["public_idioma_masterlist"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_autor_masterlist";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterlistheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["public_autor_masterlist"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_tema_masterlist";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterlistheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["public_tema_masterlist"] = $layout;
