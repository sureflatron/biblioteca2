...
require_once("include/public_lector_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_lector_edit";
...
$page_layouts["public_lector_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_lector_list";
...
$page_layouts["public_lector_list"] = $layout;
...
$keys = array();
$keys["idlector"] = postvalue("editid1");
