...
$layout = new TLayout("import_bootstrap", "ExtravaganzaOrange", "MobileOrange");
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_ejemplares_import";
...
$page_layouts["public_ejemplares_import"] = $layout;
