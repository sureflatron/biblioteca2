...
$layout = new TLayout("add_bootstrap", "ExtravaganzaOrange", "MobileOrange");
$layout->version = 3;
	$layout->bootstrapTheme = "cyborg";
		$layout->customCssPageName = "public_ejemplares_add";
...
$page_layouts["public_ejemplares_add"] = $layout;
