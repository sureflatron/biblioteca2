...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("public.usuario");
}
...
class tDAL
{
	var $tblbibliotecasw2_at_localhost_public_autor;
	var $tblbibliotecasw2_at_localhost_public_editorial;
	var $tblbibliotecasw2_at_localhost_public_ejemplares;
	var $tblbibliotecasw2_at_localhost_public_estado;
	var $tblbibliotecasw2_at_localhost_public_idioma;
	var $tblbibliotecasw2_at_localhost_public_lector;
	var $tblbibliotecasw2_at_localhost_public_libro;
	var $tblbibliotecasw2_at_localhost_public_prestamo;
	var $tblbibliotecasw2_at_localhost_public_tema;
	var $tblbibliotecasw2_at_localhost_public_usuario;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "autor", "varname" => "bibliotecasw2_at_localhost_public_autor", "altvarname" => "autor", "connId" => "bibliotecasw2_at_localhost", "schema" => "public", "connName" => "bibliotecasw2 at localhost");
		$this->lstTables[] = array("name" => "editorial", "varname" => "bibliotecasw2_at_localhost_public_editorial", "altvarname" => "editorial", "connId" => "bibliotecasw2_at_localhost", "schema" => "public", "connName" => "bibliotecasw2 at localhost");
		$this->lstTables[] = array("name" => "ejemplares", "varname" => "bibliotecasw2_at_localhost_public_ejemplares", "altvarname" => "ejemplares", "connId" => "bibliotecasw2_at_localhost", "schema" => "public", "connName" => "bibliotecasw2 at localhost");
		$this->lstTables[] = array("name" => "estado", "varname" => "bibliotecasw2_at_localhost_public_estado", "altvarname" => "estado", "connId" => "bibliotecasw2_at_localhost", "schema" => "public", "connName" => "bibliotecasw2 at localhost");
		$this->lstTables[] = array("name" => "idioma", "varname" => "bibliotecasw2_at_localhost_public_idioma", "altvarname" => "idioma", "connId" => "bibliotecasw2_at_localhost", "schema" => "public", "connName" => "bibliotecasw2 at localhost");
		$this->lstTables[] = array("name" => "lector", "varname" => "bibliotecasw2_at_localhost_public_lector", "altvarname" => "lector", "connId" => "bibliotecasw2_at_localhost", "schema" => "public", "connName" => "bibliotecasw2 at localhost");
		$this->lstTables[] = array("name" => "libro", "varname" => "bibliotecasw2_at_localhost_public_libro", "altvarname" => "libro", "connId" => "bibliotecasw2_at_localhost", "schema" => "public", "connName" => "bibliotecasw2 at localhost");
		$this->lstTables[] = array("name" => "prestamo", "varname" => "bibliotecasw2_at_localhost_public_prestamo", "altvarname" => "prestamo", "connId" => "bibliotecasw2_at_localhost", "schema" => "public", "connName" => "bibliotecasw2 at localhost");
		$this->lstTables[] = array("name" => "tema", "varname" => "bibliotecasw2_at_localhost_public_tema", "altvarname" => "tema", "connId" => "bibliotecasw2_at_localhost", "schema" => "public", "connName" => "bibliotecasw2 at localhost");
		$this->lstTables[] = array("name" => "usuario", "varname" => "bibliotecasw2_at_localhost_public_usuario", "altvarname" => "usuario", "connId" => "bibliotecasw2_at_localhost", "schema" => "public", "connName" => "bibliotecasw2 at localhost");
	}
