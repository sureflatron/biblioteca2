...
function checkTableName($shortTName, $type=false)
{
	...
	if ("public_autor" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_editorial" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_ejemplares" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_estado" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_idioma" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_libro" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_lector" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_prestamo" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_tema" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("public_usuario" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
{
	$arr = array();
	$strPerm = GetUserPermissions("public.autor");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="public.autor";
	}
	$strPerm = GetUserPermissions("public.editorial");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="public.editorial";
	}
	$strPerm = GetUserPermissions("public.ejemplares");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="public.ejemplares";
	}
	...
	$strPerm = GetUserPermissions("public.idioma");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="public.idioma";
	}
	$strPerm = GetUserPermissions("public.libro");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="public.libro";
	}
	$strPerm = GetUserPermissions("public.lector");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="public.lector";
	}
	$strPerm = GetUserPermissions("public.prestamo");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="public.prestamo";
	}
	$strPerm = GetUserPermissions("public.tema");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="public.tema";
	}
	$strPerm = GetUserPermissions("public.usuario");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="public.usuario";
	}
...
function GetUserPermissionsStatic( $table )
{
	...
	if($table=="public.autor" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="public.autor")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="public.editorial" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="public.editorial")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="public.ejemplares" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="public.ejemplares")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="public.estado" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	...
	if($table=="public.idioma" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="public.idioma")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="public.libro" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="public.libro")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="public.lector" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="public.lector")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="public.prestamo" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="public.prestamo")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="public.tema" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="public.tema")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="public.usuario" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions
	if($table=="public.usuario")
	{
		return "".$extraPerm;
	}
...
function AfterFBLogIn($pUsername, $pPassword, &$pageObject = null)
{
	...
	$strSQL = "select * from ".$connection->addTableWrappers("public.usuario")
...
{
	global $globalEvents;
	$_SESSION["GroupID"] = $data["idusuario"];
