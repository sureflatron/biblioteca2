...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("public.usuario", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "public.autor" ] = array( "url" => "public_autor", "type" => 0 );
	$projectEntitiesReverse[ "public_autor" ] = "public.autor";
	$projectEntities[ "public.editorial" ] = array( "url" => "public_editorial", "type" => 0 );
	$projectEntitiesReverse[ "public_editorial" ] = "public.editorial";
	$projectEntities[ "public.ejemplares" ] = array( "url" => "public_ejemplares", "type" => 0 );
	$projectEntitiesReverse[ "public_ejemplares" ] = "public.ejemplares";
	$projectEntities[ "public.estado" ] = array( "url" => "public_estado", "type" => 0 );
	$projectEntitiesReverse[ "public_estado" ] = "public.estado";
	$projectEntities[ "public.idioma" ] = array( "url" => "public_idioma", "type" => 0 );
	$projectEntitiesReverse[ "public_idioma" ] = "public.idioma";
	$projectEntities[ "public.libro" ] = array( "url" => "public_libro", "type" => 0 );
	$projectEntitiesReverse[ "public_libro" ] = "public.libro";
	$projectEntities[ "public.lector" ] = array( "url" => "public_lector", "type" => 0 );
	$projectEntitiesReverse[ "public_lector" ] = "public.lector";
	$projectEntities[ "public.prestamo" ] = array( "url" => "public_prestamo", "type" => 0 );
	$projectEntitiesReverse[ "public_prestamo" ] = "public.prestamo";
	$projectEntities[ "public.tema" ] = array( "url" => "public_tema", "type" => 0 );
	$projectEntitiesReverse[ "public_tema" ] = "public.tema";
	$projectEntities[ "public.usuario" ] = array( "url" => "public_usuario", "type" => 0 );
	$projectEntitiesReverse[ "public_usuario" ] = "public.usuario";
}
