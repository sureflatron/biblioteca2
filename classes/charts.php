...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("public.autor" == $this->chrt_array['tables'][0])
			return true;
		if("public.editorial" == $this->chrt_array['tables'][0])
			return true;
		if("public.ejemplares" == $this->chrt_array['tables'][0])
			return true;
		if("public.estado" == $this->chrt_array['tables'][0])
			return true;
		if("public.idioma" == $this->chrt_array['tables'][0])
			return true;
		if("public.libro" == $this->chrt_array['tables'][0])
			return true;
		if("public.lector" == $this->chrt_array['tables'][0])
			return true;
		if("public.prestamo" == $this->chrt_array['tables'][0])
			return true;
		if("public.tema" == $this->chrt_array['tables'][0])
			return true;
		if("public.usuario" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
